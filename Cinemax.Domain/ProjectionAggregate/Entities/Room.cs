...
public class Room: Entity<RoomId>{
    ...
    private Room(RoomId RoomId, int height, int width,string name, ICollection<RoomType.Entities.RoomType> roomTypes = null!)
        : base(RoomId){
            Height = height;
            Width = width;
            Name = name;
    ...
    public static Room Create(int height, int width, string name,  ICollection<RoomType.Entities.RoomType> roomTypes = null!){
