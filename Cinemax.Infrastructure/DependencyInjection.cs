...
public static class DependencyInjection{
    ...
    public static IServiceCollection AddPersistance(this IServiceCollection services){
        ...
        services.AddDbContext<CinemaxDbContext>(options => options.UseSqlServer("Server=LAPTOP-PO2FBC8G\\SQLEXPRESS;Database=cinemax;User Id=cinemax;Password=cinemax;TrustServerCertificate=true;MultipleActiveResultSets=True"));
